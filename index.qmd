...
> Lyon, N.J. (2025). Programming in R for Biologists (v1.0). Zenodo. [doi.org/10.5281/zenodo.17201332](https://doi.org/10.5281/zenodo.17201332)
...
I recognize that CRAN's website is very simple, but this program is the industry standard and enjoys the support of a large and active population of users. When you are troubleshooting (a.k.a. "debugging") your code, you will very much appreciate the breadth of people who are also using R. Follow the "Download R for ..." link for your computer operating system (i.e., Mac vs. Windows vs. Linux) to install R.
...
3. Quarto ([quarto.org](https://quarto.org/))

Quarto is software that lets you create "computational notebook" files. This type of file allows you to create a document that is a mix of working code and non-code components. This is particularly helpful for generating reports that are interpretable by those without strong code comprehension as well as--in your case--being a nice option for doing your homework as you can include the homework questions in addition to your plain-text and code answers to them.
...
5.  Miscellaneous peer-reviewed articles / book excerpts
