...
You can download the data here: {{< fa file-csv >}} [bees.csv](https://github.com/njlyon0/teach_r-for-biologists/blob/main/ext_data/bees.csv)
...
You can download the data here: {{< fa file-csv >}} [tree_lichen.csv](https://github.com/njlyon0/teach_r-for-biologists/blob/main/ext_data/tree_lichen.csv)
...
You can download the data here: {{< fa file-csv >}} [tree_road.csv](https://github.com/njlyon0/teach_r-for-biologists/blob/main/ext_data/tree_road.csv)
...
You can download the data here: {{< fa file-csv >}} [minnow.csv](https://github.com/njlyon0/teach_r-for-biologists/blob/main/ext_data/minnow.csv)
...
{{< fa file-csv >}} [tomato.csv](https://github.com/njlyon0/teach_r-for-biologists/blob/main/ext_data/tomato.csv) is the "actual" data for the project. It includes 10 plants and the number of buds, flowers, and fruits counted on each plant.

{{< fa file-csv >}} [tomato_treatment.csv](https://github.com/njlyon0/teach_r-for-biologists/blob/main/ext_data/tomato_treatment.csv) identifies which treatment (none vs. added N) was applied to each of the 10 plants

{{< fa file-csv >}} [tomato_issues.csv](https://github.com/njlyon0/teach_r-for-biologists/blob/main/ext_data/tomato_issues.csv) explains some issues that are plant-specific (i.e., over watered, herbivore damaged, etc.) and includes all plants (even those without any documented problems).
