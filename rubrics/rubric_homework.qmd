...
| 7 | - Attempts to accomplish the task and makes moderate progress using the core concept(s) </br> - Follows reproducibility best practices reasonably well with a few areas without comments / function argument definition | 
| 5 | - Task partially complete but either fails to reach a solution or makes some critical misstep </br> - Partial adherence to reproducibility best practices but lacking for much of the code |
| 3 | - Answer demonstrates a lack of understanding of the core concept </br> - Lacks reproducibility components |
| 1 | - Homework incomplete and does not demonstrate understanding of core concept </br> - Reproducibility considerations absent |
