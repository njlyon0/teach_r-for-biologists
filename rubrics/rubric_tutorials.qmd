...
| Assignment Component | Due Date |
|:--------|:---|
| Look through CRAN for 7-10 potential functions (7-10 so you have alternates if others pick the functions you had in mind) | Due before Lecture #4 at midnight |
| Pick 3 functions for your assignment | Done _during class_ in Lecture #4 |
| Submit Quarto file (.qmd) of function tutorials (Draft #1) | Due day before Lab #5 at midnight |
| Present tutorials (Draft #1); You will also submit your peer reviews for your peers' tutorials during lab this day | Done _during class_ in Lab #5 |
| Submit Quarto file of function tutorials (Draft #2) | Due day before Lab #7 at midnight |
| Present tutorials (Draft #2); Again, you'll submit peer reviews of others' revised presentations today | Done _during class_ in Lab #7|
| _OPTIONAL:_ Submit Quarto file of function tutorials (Draft #3) | Due day before Lab #8 at midnight |
