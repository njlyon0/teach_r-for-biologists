...
- Imagine a useful piece of feedback then <u>write the question that prompts it</u>
...
- Your form should have (at least) questions about the following topics:
    1. Effectiveness of your tutorial's format
    2. Any comments about your presentation style / pace
    3. Questions specific to each of your chosen functions
    4. [Another question you think would be valuable]{.gold}
...
- Screen share your knit .Rmd with the class
...
- Walk us through the tutorial + end with Q&A
...
- Find & open your R Markdown file
    - Knit it to be sure that you have the latest version
    - Open the knit product (PDF / HTML)
...
- Function Tutorials [Draft 2]{.pink}
