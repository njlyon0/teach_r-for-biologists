...
Slides {{< fa person-chalkboard >}} -- [Full Screen](slides_8a.qmd){target="_blank"}
...
Slides {{< fa person-chalkboard >}} -- [Full Screen](slides_bonus-biodiversity.qmd){target="_blank"}
